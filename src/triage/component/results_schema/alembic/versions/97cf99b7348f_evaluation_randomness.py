...
def upgrade():
    ...
    op.execute(text("update train_results.evaluations set stochastic_value = value, num_sort_trials = 1"))
    op.execute(text("update test_results.evaluations set stochastic_value = value, num_sort_trials = 1"))
...
def downgrade():
    ...
    op.execute(text("update train_results.evaluations set value = stochastic_value"))
    op.execute(text("update test_results.evaluations set value = stochastic_value"))
